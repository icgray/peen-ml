...
for coef, name_suffix in expansion_data:
    ...
    for i in range(pattern_number):
        for j in range(pattern_number):
            ...
            np.savetxt(
                os.path.join(simulation_folder, "disp_node_labels.csv"), disp_node_labels, fmt="%d", delimiter=","
            )
            ...
            np.savetxt(
                os.path.join(simulation_folder, "stress_element_labels.csv"),
                stress_element_labels,
                fmt="%d",
                delimiter=",",
            )
            ...
            np.savetxt(
                os.path.join(simulation_folder, "element_connectivity.csv"),
                element_connectivity,
                fmt="%d",
                delimiter=",",
            )
